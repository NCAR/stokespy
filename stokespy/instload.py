...
def load_HMI_stokes(user_date, user_notify, user_dir=None, max_conn=1, download=False, show_files=False, derotate=False):
    """
    ...
    lvl1_c_HMI = stokespy.StokesCube(level1_data, level1_wcs)
    print('Created HMI StokesCube with shape: ', lvl1_c_HMI.data.shape)
    print('WCS for the StokesCube is: ', lvl1_c_HMI.wcs)
    
    return lvl1_c_HMI
    
    
def load_HMI_magvec(user_date, user_notify, user_dir=None, max_conn=1, download=False, show_files=False, derotate=False):
    """
    ...
    lvl2_c_HMI = stokespy.MagVectorCube(level2_data, level2_wcs)
    print('Created HMI MagVectorCube with shape: ', lvl2_c_HMI.data.shape)
    print('WCS for the MagVectorCube is: ', lvl2_c_HMI.wcs)
    return lvl2_c_HMI
    
def load_HinodeSP_stokes(user_date, user_dir=None, show_files=False, magnetic_params=['Field_Strength', 'Field_Inclination', 'Field_Azimuth']):
    """
    Function that loads the level1 Hinode SP observations associated with the string user_date.
    ----------
    ...
    # The axes order needs to be re-arranged.
    level1_data = level1_data.transpose(1, 3, 2, 0) 
    ...
    level1_wcs.wcs.crpix = [(Nx+1)/2, (Ny+1)/2, head1['CRPIX1'], 0]
    ...
    level1_wcs.wcs.cdelt = [head1['XSCALE'], head1['YSCALE'], head1['CDELT1'], 1]
    level1_wcs.wcs.set()
    
    lvl1_c_SP = stokespy.StokesCube(level1_data, level1_wcs)
    print('Created Hinode/SP StokesCube with shape: ', lvl1_c_SP.data.shape)
    print('WCS for the StokesCube is: ', lvl1_c_SP.wcs)
...
def load_HinodeSP_magvec(user_date, user_dir=None, show_files=False, magnetic_params=['Field_Strength', 'Field_Inclination', 'Field_Azimuth']):
    ...
    # Create the HMI Cubes
    lvl2_c_SP = stokespy.MagVectorCube(level2_data, level2_wcs)
    print('Created Hinode/SP MagVectorCube with shape: ', lvl2_c_SP.data.shape)
    print('WCS for the MagVectorCube is: ', lvl2_c_SP.wcs)
    return lvl2_c_SP
